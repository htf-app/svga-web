class Downloader {
  ...
  get(t) {
    ...
    return new Promise((h, n) => {
      ...
      a.open("GET", t, !0), a.responseType = "arraybuffer", a.onloadend = () => {
        a.response && (a.status === 200 || a.status === 304) ? h(a.response) : n(a);
      }, a.onerror = () => n(a.response), a.send(), this.request = a;
    });
  }
  cancel() {
    var t;
    (t = this.request) == null || t.abort();
  }
  destroy() {
    var t;
    (t = this.request) == null || t.abort();
...
var Version = /* @__PURE__ */ ((l) => (l[l.VERSION_1 = 1] = "VERSION_1", l[l.VERSION_2 = 2] = "VERSION_2", l))(Version || {});
function getVersion(l) {
  return l[0] == 80 && l[1] == 75 && l[2] == 3 && l[3] == 4 ? 1 : 2;
}
...
function requireAspromise() {
  ...
  function l(t, h) {
    for (var n = new Array(arguments.length - 1), a = 0, e = 2, i = !0; e < arguments.length; )
      n[a++] = arguments[e++];
...
function requireBase64() {
  return hasRequiredBase64 || (hasRequiredBase64 = 1, function(l) {
    ...
    t.length = function(r) {
      ...
      if (!o)
        return 0;
      for (var u = 0; --o % 4 > 1 && r.charAt(o) === "="; )
        ++u;
      return Math.ceil(r.length * 3) / 4 - u;
    };
    for (var h = new Array(64), n = new Array(123), a = 0; a < 64; )
      n[h[a] = a < 26 ? a + 65 : a < 52 ? a + 71 : a < 62 ? a - 4 : a - 59 | 43] = a++;
    t.encode = function(r, o, u) {
      for (var d = null, s = [], f = 0, c = 0, p; o < u; ) {
        var g = r[o++];
        switch (c) {
          case 0:
            s[f++] = h[g >> 2], p = (g & 3) << 4, c = 1;
            break;
          case 1:
            s[f++] = h[p | g >> 4], p = (g & 15) << 2, c = 2;
            break;
          case 2:
            s[f++] = h[p | g >> 6], s[f++] = h[g & 63], c = 0;
            break;
        }
        f > 8191 && ((d || (d = [])).push(String.fromCharCode.apply(String, s)), f = 0);
      }
      return c && (s[f++] = h[p], s[f++] = 61, c === 1 && (s[f++] = 61)), d ? (f && d.push(String.fromCharCode.apply(String, s.slice(0, f))), d.join("")) : String.fromCharCode.apply(String, s.slice(0, f));
    };
    var e = "invalid encoding";
    t.decode = function(r, o, u) {
      for (var d = u, s = 0, f, c = 0; c < r.length; ) {
        ...
        switch (s) {
          case 0:
            ...
            break;
          case 1:
            o[u++] = f << 2 | (p & 48) >> 4, f = p, s = 2;
            break;
          case 2:
            o[u++] = (f & 15) << 4 | (p & 60) >> 2, f = p, s = 3;
            break;
          case 3:
            o[u++] = (f & 3) << 6 | p, s = 0;
            break;
...
function requireEventemitter() {
  ...
  return l.prototype.on = function(h, n, a) {
    return (this._listeners[h] || (this._listeners[h] = [])).push({
      fn: n,
      ctx: a || this
    }), this;
  }, l.prototype.off = function(h, n) {
    if (h === void 0)
      this._listeners = {};
    else if (n === void 0)
      this._listeners[h] = [];
    else
      for (var a = this._listeners[h], e = 0; e < a.length; )
        a[e].fn === n ? a.splice(e, 1) : ++e;
    return this;
  }, l.prototype.emit = function(h) {
    var n = this._listeners[h];
    if (n) {
      for (var a = [], e = 1; e < arguments.length; )
        a.push(arguments[e++]);
      for (e = 0; e < n.length; )
        n[e].fn.apply(n[e++].ctx, a);
    }
    return this;
  }, eventemitter;
}
...
function requireFloat() {
  ...
  function l(e) {
    return typeof Float32Array < "u" ? function() {
      var i = new Float32Array([-0]), r = new Uint8Array(i.buffer), o = r[3] === 128;
      function u(c, p, g) {
        i[0] = c, p[g] = r[0], p[g + 1] = r[1], p[g + 2] = r[2], p[g + 3] = r[3];
      }
      function d(c, p, g) {
        i[0] = c, p[g] = r[3], p[g + 1] = r[2], p[g + 2] = r[1], p[g + 3] = r[0];
      }
      e.writeFloatLE = o ? u : d, e.writeFloatBE = o ? d : u;
      function s(c, p) {
        return r[0] = c[p], r[1] = c[p + 1], r[2] = c[p + 2], r[3] = c[p + 3], i[0];
      }
      function f(c, p) {
        return r[3] = c[p], r[2] = c[p + 1], r[1] = c[p + 2], r[0] = c[p + 3], i[0];
      }
      e.readFloatLE = o ? s : f, e.readFloatBE = o ? f : s;
    }() : function() {
      function i(o, u, d, s) {
        var f = u < 0 ? 1 : 0;
        if (f && (u = -u), u === 0)
          ...
          o((f << 31 | 2139095040) >>> 0, d, s);
        else if (u < 11754943508222875e-54)
          o((f << 31 | Math.round(u / 1401298464324817e-60)) >>> 0, d, s);
        else {
          var c = Math.floor(Math.log(u) / Math.LN2), p = Math.round(u * Math.pow(2, -c) * 8388608) & 8388607;
          o((f << 31 | c + 127 << 23 | p) >>> 0, d, s);
        }
      }
      e.writeFloatLE = i.bind(null, t), e.writeFloatBE = i.bind(null, h);
      function r(o, u, d) {
        var s = o(u, d), f = (s >> 31) * 2 + 1, c = s >>> 23 & 255, p = s & 8388607;
        return c === 255 ? p ? NaN : f * (1 / 0) : c === 0 ? f * 1401298464324817e-60 * p : f * Math.pow(2, c - 150) * (p + 8388608);
      }
      e.readFloatLE = r.bind(null, n), e.readFloatBE = r.bind(null, a);
    }(), typeof Float64Array < "u" ? function() {
      var i = new Float64Array([-0]), r = new Uint8Array(i.buffer), o = r[7] === 128;
      function u(c, p, g) {
        i[0] = c, p[g] = r[0], p[g + 1] = r[1], p[g + 2] = r[2], p[g + 3] = r[3], p[g + 4] = r[4], p[g + 5] = r[5], p[g + 6] = r[6], p[g + 7] = r[7];
      }
      function d(c, p, g) {
        i[0] = c, p[g] = r[7], p[g + 1] = r[6], p[g + 2] = r[5], p[g + 3] = r[4], p[g + 4] = r[3], p[g + 5] = r[2], p[g + 6] = r[1], p[g + 7] = r[0];
      }
      e.writeDoubleLE = o ? u : d, e.writeDoubleBE = o ? d : u;
      function s(c, p) {
        return r[0] = c[p], r[1] = c[p + 1], r[2] = c[p + 2], r[3] = c[p + 3], r[4] = c[p + 4], r[5] = c[p + 5], r[6] = c[p + 6], r[7] = c[p + 7], i[0];
      }
      function f(c, p) {
        return r[7] = c[p], r[6] = c[p + 1], r[5] = c[p + 2], r[4] = c[p + 3], r[3] = c[p + 4], r[2] = c[p + 5], r[1] = c[p + 6], r[0] = c[p + 7], i[0];
      }
      e.readDoubleLE = o ? s : f, e.readDoubleBE = o ? f : s;
    }() : function() {
      function i(o, u, d, s, f, c) {
        var p = s < 0 ? 1 : 0;
        if (p && (s = -s), s === 0)
          o(0, f, c + u), o(1 / s > 0 ? (
            /* positive */
          ...
          o(0, f, c + u), o(2146959360, f, c + d);
        else if (s > 17976931348623157e292)
          o(0, f, c + u), o((p << 31 | 2146435072) >>> 0, f, c + d);
        else {
          var g;
          if (s < 22250738585072014e-324)
            g = s / 5e-324, o(g >>> 0, f, c + u), o((p << 31 | g / 4294967296) >>> 0, f, c + d);
          else {
            var y = Math.floor(Math.log(s) / Math.LN2);
            y === 1024 && (y = 1023), g = s * Math.pow(2, -y), o(g * 4503599627370496 >>> 0, f, c + u), o((p << 31 | y + 1023 << 20 | g * 1048576 & 1048575) >>> 0, f, c + d);
          }
        }
      }
      e.writeDoubleLE = i.bind(null, t, 0, 4), e.writeDoubleBE = i.bind(null, h, 4, 0);
      function r(o, u, d, s, f) {
        var c = o(s, f + u), p = o(s, f + d), g = (p >> 31) * 2 + 1, y = p >>> 20 & 2047, m = 4294967296 * (p & 1048575) + c;
        return y === 2047 ? m ? NaN : g * (1 / 0) : y === 0 ? g * 5e-324 * m : g * Math.pow(2, y - 1075) * (m + 4503599627370496);
      }
      e.readDoubleLE = r.bind(null, n, 0, 4), e.readDoubleBE = r.bind(null, a, 4, 0);
    }(), e;
  }
  function t(e, i, r) {
    i[r] = e & 255, i[r + 1] = e >>> 8 & 255, i[r + 2] = e >>> 16 & 255, i[r + 3] = e >>> 24;
  }
  function h(e, i, r) {
    i[r] = e >>> 24, i[r + 1] = e >>> 16 & 255, i[r + 2] = e >>> 8 & 255, i[r + 3] = e & 255;
  }
  function n(e, i) {
    return (e[i] | e[i + 1] << 8 | e[i + 2] << 16 | e[i + 3] << 24) >>> 0;
  }
  function a(e, i) {
    return (e[i] << 24 | e[i + 1] << 16 | e[i + 2] << 8 | e[i + 3]) >>> 0;
  }
  return float;
}
...
function requireUtf8() {
  return hasRequiredUtf8 || (hasRequiredUtf8 = 1, function(l) {
    var t = l;
    t.length = function(n) {
      for (var a = 0, e = 0, i = 0; i < n.length; ++i)
        e = n.charCodeAt(i), e < 128 ? a += 1 : e < 2048 ? a += 2 : (e & 64512) === 55296 && (n.charCodeAt(i + 1) & 64512) === 56320 ? (++i, a += 4) : a += 3;
      return a;
    }, t.read = function(n, a, e) {
      var i = e - a;
      if (i < 1)
        return "";
      for (var r = null, o = [], u = 0, d; a < e; )
        d = n[a++], d < 128 ? o[u++] = d : d > 191 && d < 224 ? o[u++] = (d & 31) << 6 | n[a++] & 63 : d > 239 && d < 365 ? (d = ((d & 7) << 18 | (n[a++] & 63) << 12 | (n[a++] & 63) << 6 | n[a++] & 63) - 65536, o[u++] = 55296 + (d >> 10), o[u++] = 56320 + (d & 1023)) : o[u++] = (d & 15) << 12 | (n[a++] & 63) << 6 | n[a++] & 63, u > 8191 && ((r || (r = [])).push(String.fromCharCode.apply(String, o)), u = 0);
      return r ? (u && r.push(String.fromCharCode.apply(String, o.slice(0, u))), r.join("")) : String.fromCharCode.apply(String, o.slice(0, u));
    }, t.write = function(n, a, e) {
      for (var i = e, r, o, u = 0; u < n.length; ++u)
        r = n.charCodeAt(u), r < 128 ? a[e++] = r : r < 2048 ? (a[e++] = r >> 6 | 192, a[e++] = r & 63 | 128) : (r & 64512) === 55296 && ((o = n.charCodeAt(u + 1)) & 64512) === 56320 ? (r = 65536 + ((r & 1023) << 10) + (o & 1023), ++u, a[e++] = r >> 18 | 240, a[e++] = r >> 12 & 63 | 128, a[e++] = r >> 6 & 63 | 128, a[e++] = r & 63 | 128) : (a[e++] = r >> 12 | 224, a[e++] = r >> 6 & 63 | 128, a[e++] = r & 63 | 128);
      return e - i;
    };
  }(utf8)), utf8;
}
...
function requirePool() {
  ...
  function l(t, h, n) {
    var a = n || 8192, e = a >>> 1, i = null, r = a;
    return function(u) {
      if (u < 1 || u > e)
        return t(u);
      r + u > a && (i = t(a), r = 0);
      var d = h.call(i, r, r += u);
      return r & 7 && (r = (r | 7) + 1), d;
    };
  }
  return pool_1;
}
...
function requireLongbits() {
  ...
  function t(e, i) {
    this.lo = e >>> 0, this.hi = i >>> 0;
  }
  var h = t.zero = new t(0, 0);
  h.toNumber = function() {
    return 0;
  ...
  t.fromNumber = function(i) {
    ...
    var r = i < 0;
    r && (i = -i);
    var o = i >>> 0, u = (i - o) / 4294967296 >>> 0;
    return r && (u = ~u >>> 0, o = ~o >>> 0, ++o > 4294967295 && (o = 0, ++u > 4294967295 && (u = 0))), new t(o, u);
  }, t.from = function(i) {
    if (typeof i == "number")
      return t.fromNumber(i);
    if (l.isString(i))
      if (l.Long)
        i = l.Long.fromString(i);
      else
        return t.fromNumber(parseInt(i, 10));
    return i.low || i.high ? new t(i.low >>> 0, i.high >>> 0) : h;
  }, t.prototype.toNumber = function(i) {
    if (!i && this.hi >>> 31) {
      var r = ~this.lo + 1 >>> 0, o = ~this.hi >>> 0;
      return r || (o = o + 1 >>> 0), -(r + o * 4294967296);
    }
    return this.lo + this.hi * 4294967296;
  }, t.prototype.toLong = function(i) {
    return l.Long ? new l.Long(this.lo | 0, this.hi | 0, !!i) : { low: this.lo | 0, high: this.hi | 0, unsigned: !!i };
  };
  ...
  return t.fromHash = function(i) {
    ...
    var i = this.lo, r = (this.lo >>> 28 | this.hi << 4) >>> 0, o = this.hi >>> 24;
    return o === 0 ? r === 0 ? i < 16384 ? i < 128 ? 1 : 2 : i < 2097152 ? 3 : 4 : r < 16384 ? r < 128 ? 5 : 6 : r < 2097152 ? 7 : 8 : o < 128 ? 9 : 10;
  }, longbits;
}
...
function requireMinimal$1() {
  return hasRequiredMinimal$1 || (hasRequiredMinimal$1 = 1, function(l) {
    ...
    t.isSet = function(e, i) {
      var r = e[i];
      return r != null && e.hasOwnProperty(i) ? typeof r != "object" || (Array.isArray(r) ? r.length : Object.keys(r).length) > 0 : !1;
    }, t.Buffer = function() {
      try {
        var a = t.inquire("buffer").Buffer;
    ...
    t.global.Long || t.inquire("long"), t.key2Re = /^true|false|0|1$/, t.key32Re = /^-?(?:0|[1-9][0-9]*)$/, t.key64Re = /^(?:[\\x00-\\xff]{8}|-?(?:0|[1-9][0-9]*))$/, t.longToHash = function(e) {
      return e ? t.LongBits.from(e).toHash() : t.LongBits.zeroHash;
    }, t.longFromHash = function(e, i) {
      var r = t.LongBits.fromHash(e);
      return t.Long ? t.Long.fromBits(r.lo, r.hi, i) : r.toNumber(!!i);
    };
    function h(a, e, i) {
      for (var r = Object.keys(e), o = 0; o < r.length; ++o)
        (a[r[o]] === void 0 || !i) && (a[r[o]] = e[r[o]]);
      return a;
    }
    t.merge = h, t.lcFirst = function(e) {
    ...
    function n(a) {
      function e(i, r) {
        ...
        Object.defineProperty(this, "message", { get: function() {
          return i;
        } }), Error.captureStackTrace ? Error.captureStackTrace(this, e) : Object.defineProperty(this, "stack", { value: new Error().stack || "" }), r && h(this, r);
      }
    ...
    t.newError = n, t.ProtocolError = n("ProtocolError"), t.oneOfGetter = function(e) {
      for (var i = {}, r = 0; r < e.length; ++r)
        i[e[r]] = 1;
      return function() {
        for (var o = Object.keys(this), u = o.length - 1; u > -1; --u)
          if (i[o[u]] === 1 && this[o[u]] !== void 0 && this[o[u]] !== null)
            return o[u];
      };
      ...
      t._Buffer_from = a.from !== Uint8Array.from && a.from || /* istanbul ignore next */
      function(i, r) {
        return new a(i, r);
      }, t._Buffer_allocUnsafe = a.allocUnsafe || /* istanbul ignore next */
      function(i) {
        return new a(i);
      };
    };
...
function requireWriter() {
  ...
  var l = requireMinimal$1(), t, h = l.LongBits, n = l.base64, a = l.utf8;
  function e(y, m, b) {
    this.fn = y, this.len = m, this.next = void 0, this.val = b;
  }
  function i() {
  }
  function r(y) {
    this.head = y.head, this.tail = y.tail, this.len = y.len, this.next = y.states;
  }
  function o() {
    this.len = 0, this.head = new e(i, 0, 0), this.tail = this.head, this.states = null;
  }
  var u = function() {
  ...
  o.create = u(), o.alloc = function(m) {
    return new l.Array(m);
  }, l.Array !== Array && (o.alloc = l.pool(o.alloc, l.Array.prototype.subarray)), o.prototype._push = function(m, b, w) {
    return this.tail = this.tail.next = new e(m, b, w), this.len += b, this;
  };
  function d(y, m, b) {
    m[b] = y & 255;
  }
  ...
  function f(y, m) {
    this.len = y, this.next = void 0, this.val = m;
  }
  f.prototype = Object.create(e.prototype), f.prototype.fn = s, o.prototype.uint32 = function(m) {
    ...
    return m < 0 ? this._push(c, 10, h.fromNumber(m)) : this.uint32(m);
  }, o.prototype.sint32 = function(m) {
    return this.uint32((m << 1 ^ m >> 31) >>> 0);
  };
  function c(y, m, b) {
    for (; y.hi; )
      m[b++] = y.lo & 127 | 128, y.lo = (y.lo >>> 7 | y.hi << 25) >>> 0, y.hi >>>= 7;
    for (; y.lo > 127; )
      m[b++] = y.lo & 127 | 128, y.lo = y.lo >>> 7;
    m[b++] = y.lo;
  }
  o.prototype.uint64 = function(m) {
    ...
    var b = h.from(m).zzEncode();
    return this._push(c, b.length(), b);
  }, o.prototype.bool = function(m) {
    return this._push(d, 1, m ? 1 : 0);
  };
  function p(y, m, b) {
    m[b] = y & 255, m[b + 1] = y >>> 8 & 255, m[b + 2] = y >>> 16 & 255, m[b + 3] = y >>> 24;
  }
  o.prototype.fixed32 = function(m) {
    ...
    var b = h.from(m);
    return this._push(p, 4, b.lo)._push(p, 4, b.hi);
  }, o.prototype.sfixed64 = o.prototype.fixed64, o.prototype.float = function(m) {
    return this._push(l.float.writeFloatLE, 4, m);
  }, o.prototype.double = function(m) {
    return this._push(l.float.writeDoubleLE, 8, m);
  };
  var g = l.Array.prototype.set ? function(m, b, w) {
    b.set(m, w);
  } : function(m, b, w) {
  ...
  return o.prototype.bytes = function(m) {
    ...
    if (l.isString(m)) {
      var w = o.alloc(b = n.length(m));
      n.decode(m, w, 0), m = w;
    }
    return this.uint32(b)._push(g, b, m);
  }, o.prototype.string = function(m) {
    var b = a.length(m);
    return b ? this.uint32(b)._push(a.write, b, m) : this._push(d, 1, 0);
  }, o.prototype.fork = function() {
    return this.states = new r(this), this.head = this.tail = new e(i, 0, 0), this.len = 0, this;
  }, o.prototype.reset = function() {
    return this.states ? (this.head = this.states.head, this.tail = this.states.tail, this.len = this.states.len, this.states = this.states.next) : (this.head = this.tail = new e(i, 0, 0), this.len = 0), this;
  }, o.prototype.ldelim = function() {
    var m = this.head, b = this.tail, w = this.len;
    return this.reset().uint32(w), w && (this.tail.next = m.next, this.tail = b, this.len += w), this;
  }, o.prototype.finish = function() {
    for (var m = this.head.next, b = this.constructor.alloc(this.len), w = 0; m; )
      m.fn(m.val, b, w), w += m.len, m = m.next;
    return b;
  }, o._configure = function(y) {
    t = y, o.create = u(), t._configure();
  }, writer;
}
...
function requireWriter_buffer() {
  ...
  h._configure = function() {
    h.alloc = t._Buffer_allocUnsafe, h.writeBytesBuffer = t.Buffer && t.Buffer.prototype instanceof Uint8Array && t.Buffer.prototype.set.name === "set" ? function(e, i, r) {
      i.set(e, r);
    } : function(e, i, r) {
      if (e.copy)
        e.copy(i, r, 0, e.length);
      else for (var o = 0; o < e.length; )
        i[r++] = e[o++];
    };
  }, h.prototype.bytes = function(e) {
    t.isString(e) && (e = t._Buffer_from(e, "base64"));
    var i = e.length >>> 0;
    return this.uint32(i), i && this._push(h.writeBytesBuffer, i, e), this;
  };
  function n(a, e, i) {
    a.length < 40 ? t.utf8.write(a, e, i) : e.utf8Write ? e.utf8Write(a, i) : e.write(a, i);
  }
  return h.prototype.string = function(e) {
    var i = t.Buffer.byteLength(e);
    return this.uint32(i), i && this._push(n, i, e), this;
  }, h._configure(), writer_buffer;
}
var reader, hasRequiredReader;
function requireReader() {
  if (hasRequiredReader) return reader;
  hasRequiredReader = 1, reader = e;
  var l = requireMinimal$1(), t, h = l.LongBits, n = l.utf8;
  function a(s, f) {
    return RangeError("index out of range: " + s.pos + " + " + (f || 1) + " > " + s.len);
  }
  function e(s) {
  ...
  var i = typeof Uint8Array < "u" ? function(f) {
    ...
    return l.Buffer ? function(c) {
      return (e.create = function(g) {
        return l.Buffer.isBuffer(g) ? new t(g) : i(g);
      })(c);
    } : i;
  };
  e.create = r(), e.prototype._slice = l.Array.prototype.subarray || /* istanbul ignore next */
  l.Array.prototype.slice, e.prototype.uint32 = /* @__PURE__ */ function() {
    var f = 4294967295;
    return function() {
  ...
  function o() {
    ...
    if (this.len - this.pos > 4) {
      for (; f < 4; ++f)
        if (s.lo = (s.lo | (this.buf[this.pos] & 127) << f * 7) >>> 0, this.buf[this.pos++] < 128)
          return s;
      ...
      return s.lo = (s.lo | (this.buf[this.pos++] & 127) << f * 7) >>> 0, s;
    }
    if (this.len - this.pos > 4) {
      for (; f < 5; ++f)
        if (s.hi = (s.hi | (this.buf[this.pos] & 127) << f * 7 + 3) >>> 0, this.buf[this.pos++] < 128)
          return s;
    } else
      for (; f < 5; ++f) {
        if (this.pos >= this.len)
  ...
  function u(s, f) {
    return (s[f - 4] | s[f - 3] << 8 | s[f - 2] << 16 | s[f - 1] << 24) >>> 0;
  }
  ...
  function d() {
    if (this.pos + 8 > this.len)
      throw a(this, 8);
    return new h(u(this.buf, this.pos += 4), u(this.buf, this.pos += 4));
  }
  return e.prototype.float = function() {
    if (this.pos + 4 > this.len)
      throw a(this, 4);
    var f = l.float.readFloatLE(this.buf, this.pos);
    return this.pos += 4, f;
  }, e.prototype.double = function() {
    if (this.pos + 8 > this.len)
      throw a(this, 4);
    var f = l.float.readDoubleLE(this.buf, this.pos);
    return this.pos += 8, f;
  }, e.prototype.bytes = function() {
    var f = this.uint32(), c = this.pos, p = this.pos + f;
    if (p > this.len)
      throw a(this, f);
    if (this.pos += f, Array.isArray(this.buf))
      return this.buf.slice(c, p);
    if (c === p) {
      var g = l.Buffer;
      return g ? g.alloc(0) : new this.buf.constructor(0);
    }
    return this._slice.call(this.buf, c, p);
  }, e.prototype.string = function() {
    var f = this.bytes();
    return n.read(f, 0, f.length);
  }, e.prototype.skip = function(f) {
    if (typeof f == "number") {
    ...
    return this;
  }, e.prototype.skipType = function(s) {
    switch (s) {
      case 0:
        this.skip();
        break;
    ...
    return this;
  }, e._configure = function(s) {
    t = s, e.create = r(), t._configure();
    var f = l.Long ? "toLong" : (
      /* istanbul ignore next */
      "toNumber"
    );
...
function requireReader_buffer() {
  ...
  return h._configure = function() {
    t.Buffer && (h.prototype._slice = t.Buffer.prototype.slice);
...
function requireService() {
  ...
  hasRequiredService = 1, service = t;
  var l = requireMinimal$1();
  (t.prototype = Object.create(l.EventEmitter.prototype)).constructor = t;
  function t(h, n, a) {
    if (typeof h != "function")
      throw TypeError("rpcImpl must be a function");
    l.EventEmitter.call(this), this.rpcImpl = h, this.requestDelimited = !!n, this.responseDelimited = !!a;
  }
  return t.prototype.rpcCall = function h(n, a, e, i, r) {
    if (!i)
      throw TypeError("request must be specified");
    var o = this;
    if (!r)
      return l.asPromise(h, o, n, a, e, i);
    if (!o.rpcImpl) {
      setTimeout(function() {
    ...
    try {
      return o.rpcImpl(
        n,
        a[o.requestDelimited ? "encodeDelimited" : "encode"](i).finish(),
        function(d, s) {
          if (d)
            return o.emit("error", d, n), r(d);
          if (s === null) {
            o.end(
              /* endedByRPC */
              !0
          ...
          if (!(s instanceof e))
            try {
              s = e[o.responseDelimited ? "decodeDelimited" : "decode"](s);
            } catch (f) {
              return o.emit("error", f, n), r(f);
            }
          return o.emit("data", s, n), r(null, s);
        }
      );
    } catch (u) {
      o.emit("error", u, n), setTimeout(function() {
        r(u);
      }, 0);
      return;
    }
...
function requireIndexMinimal() {
  return hasRequiredIndexMinimal || (hasRequiredIndexMinimal = 1, function(l) {
    var t = l;
    t.build = "minimal", t.Writer = requireWriter(), t.BufferWriter = requireWriter_buffer(), t.Reader = requireReader(), t.BufferReader = requireReader_buffer(), t.util = requireMinimal$1(), t.rpc = requireRpc(), t.roots = requireRoots(), t.configure = h;
    function h() {
...
const $Reader = minimalExports.Reader, $util = minimalExports.util, $root = minimalExports.roots.default || (minimalExports.roots.default = {}), com = $root.com = (() => {
  const l = {};
  return l.opensource = function() {
    const t = {};
    return t.svga = function() {
      const h = {};
      return h.MovieParams = function() {
        function n(a) {
          if (a)
            for (var e = Object.keys(a), i = 0; i < e.length; ++i)
              a[e[i]] != null && (this[e[i]] = a[e[i]]);
        }
        return n.prototype.viewBoxWidth = 0, n.prototype.viewBoxHeight = 0, n.prototype.fps = 0, n.prototype.frames = 0, n.decode = function(e, i, r) {
          e instanceof $Reader || (e = $Reader.create(e));
          for (var o = i === void 0 ? e.len : e.pos + i, u = new $root.com.opensource.svga.MovieParams(); e.pos < o; ) {
            var d = e.uint32();
            if (d === r)
              break;
            switch (d >>> 3) {
              case 1: {
                u.viewBoxWidth = e.float();
                break;
              }
              case 2: {
                u.viewBoxHeight = e.float();
                break;
              }
              case 3: {
                u.fps = e.int32();
      ...
      }(), h.SpriteEntity = function() {
        function n(a) {
          if (this.frames = [], a)
            for (var e = Object.keys(a), i = 0; i < e.length; ++i)
              a[e[i]] != null && (this[e[i]] = a[e[i]]);
        }
        return n.prototype.imageKey = "", n.prototype.frames = $util.emptyArray, n.prototype.matteKey = "", n.decode = function(e, i, r) {
          e instanceof $Reader || (e = $Reader.create(e));
          for (var o = i === void 0 ? e.len : e.pos + i, u = new $root.com.opensource.svga.SpriteEntity(); e.pos < o; ) {
            var d = e.uint32();
            if (d === r)
              break;
            switch (d >>> 3) {
              ...
              case 2: {
                u.frames && u.frames.length || (u.frames = []), u.frames.push($root.com.opensource.svga.FrameEntity.decode(e, e.uint32()));
                break;
              }
              case 3: {
                u.matteKey = e.string();
      ...
      }(), h.AudioEntity = function() {
        function n(a) {
          if (a)
            for (var e = Object.keys(a), i = 0; i < e.length; ++i)
              a[e[i]] != null && (this[e[i]] = a[e[i]]);
        }
        return n.prototype.audioKey = "", n.prototype.startFrame = 0, n.prototype.endFrame = 0, n.prototype.startTime = 0, n.prototype.totalTime = 0, n.decode = function(e, i, r) {
          e instanceof $Reader || (e = $Reader.create(e));
          for (var o = i === void 0 ? e.len : e.pos + i, u = new $root.com.opensource.svga.AudioEntity(); e.pos < o; ) {
            var d = e.uint32();
            if (d === r)
              break;
            switch (d >>> 3) {
        ...
        return n.prototype.x = 0, n.prototype.y = 0, n.prototype.width = 0, n.prototype.height = 0, n.decode = function(e, i, r) {
          e instanceof $Reader || (e = $Reader.create(e));
          for (var o = i === void 0 ? e.len : e.pos + i, u = new $root.com.opensource.svga.Layout(); e.pos < o; ) {
            var d = e.uint32();
            if (d === r)
              break;
            switch (d >>> 3) {
        ...
        return n.prototype.a = 0, n.prototype.b = 0, n.prototype.c = 0, n.prototype.d = 0, n.prototype.tx = 0, n.prototype.ty = 0, n.decode = function(e, i, r) {
          e instanceof $Reader || (e = $Reader.create(e));
          for (var o = i === void 0 ? e.len : e.pos + i, u = new $root.com.opensource.svga.Transform(); e.pos < o; ) {
            var d = e.uint32();
            if (d === r)
              break;
            switch (d >>> 3) {
      ...
      }(), h.ShapeEntity = function() {
        function n(e) {
          if (e)
            for (var i = Object.keys(e), r = 0; r < i.length; ++r)
              e[i[r]] != null && (this[i[r]] = e[i[r]]);
        }
        n.prototype.type = 0, n.prototype.shape = null, n.prototype.rect = null, n.prototype.ellipse = null, n.prototype.styles = null, n.prototype.transform = null;
        let a;
        return Object.defineProperty(n.prototype, "args", {
          get: $util.oneOfGetter(a = ["shape", "rect", "ellipse"]),
          set: $util.oneOfSetter(a)
        }), n.decode = function(i, r, o) {
          i instanceof $Reader || (i = $Reader.create(i));
          for (var u = r === void 0 ? i.len : i.pos + r, d = new $root.com.opensource.svga.ShapeEntity(); i.pos < u; ) {
            var s = i.uint32();
            if (s === o)
              break;
            switch (s >>> 3) {
              ...
              case 2: {
                d.shape = $root.com.opensource.svga.ShapeEntity.ShapeArgs.decode(i, i.uint32());
                break;
              }
              case 3: {
                d.rect = $root.com.opensource.svga.ShapeEntity.RectArgs.decode(i, i.uint32());
                break;
              }
              case 4: {
                d.ellipse = $root.com.opensource.svga.ShapeEntity.EllipseArgs.decode(i, i.uint32());
                break;
              }
              case 10: {
                d.styles = $root.com.opensource.svga.ShapeEntity.ShapeStyle.decode(i, i.uint32());
                break;
              }
              case 11: {
                d.transform = $root.com.opensource.svga.Transform.decode(i, i.uint32());
                break;
              }
              default:
                i.skipType(s & 7);
          ...
          return i === void 0 && (i = "type.googleapis.com"), i + "/com.opensource.svga.ShapeEntity";
        }, n.ShapeType = function() {
          const e = {}, i = Object.create(e);
          return i[e[0] = "SHAPE"] = 0, i[e[1] = "RECT"] = 1, i[e[2] = "ELLIPSE"] = 2, i[e[3] = "KEEP"] = 3, i;
        }(), n.ShapeArgs = function() {
          function e(i) {
            if (i)
              for (var r = Object.keys(i), o = 0; o < r.length; ++o)
                i[r[o]] != null && (this[r[o]] = i[r[o]]);
          }
          return e.prototype.d = "", e.decode = function(r, o, u) {
            r instanceof $Reader || (r = $Reader.create(r));
            for (var d = o === void 0 ? r.len : r.pos + o, s = new $root.com.opensource.svga.ShapeEntity.ShapeArgs(); r.pos < d; ) {
              var f = r.uint32();
              if (f === u)
                break;
              switch (f >>> 3) {
            ...
            return r === void 0 && (r = "type.googleapis.com"), r + "/com.opensource.svga.ShapeEntity.ShapeArgs";
          }, e;
        }(), n.RectArgs = function() {
          function e(i) {
            if (i)
          ...
          return e.prototype.x = 0, e.prototype.y = 0, e.prototype.width = 0, e.prototype.height = 0, e.prototype.cornerRadius = 0, e.decode = function(r, o, u) {
            r instanceof $Reader || (r = $Reader.create(r));
            for (var d = o === void 0 ? r.len : r.pos + o, s = new $root.com.opensource.svga.ShapeEntity.RectArgs(); r.pos < d; ) {
              var f = r.uint32();
              if (f === u)
                break;
              switch (f >>> 3) {
            ...
            return r === void 0 && (r = "type.googleapis.com"), r + "/com.opensource.svga.ShapeEntity.RectArgs";
          }, e;
        }(), n.EllipseArgs = function() {
          function e(i) {
            if (i)
              for (var r = Object.keys(i), o = 0; o < r.length; ++o)
                i[r[o]] != null && (this[r[o]] = i[r[o]]);
          }
          return e.prototype.x = 0, e.prototype.y = 0, e.prototype.radiusX = 0, e.prototype.radiusY = 0, e.decode = function(r, o, u) {
            r instanceof $Reader || (r = $Reader.create(r));
            for (var d = o === void 0 ? r.len : r.pos + o, s = new $root.com.opensource.svga.ShapeEntity.EllipseArgs(); r.pos < d; ) {
              var f = r.uint32();
              if (f === u)
                break;
              switch (f >>> 3) {
            ...
            return r === void 0 && (r = "type.googleapis.com"), r + "/com.opensource.svga.ShapeEntity.EllipseArgs";
          }, e;
        }(), n.ShapeStyle = function() {
          function e(i) {
            if (i)
              for (var r = Object.keys(i), o = 0; o < r.length; ++o)
                i[r[o]] != null && (this[r[o]] = i[r[o]]);
          }
          return e.prototype.fill = null, e.prototype.stroke = null, e.prototype.strokeWidth = 0, e.prototype.lineCap = 0, e.prototype.lineJoin = 0, e.prototype.miterLimit = 0, e.prototype.lineDashI = 0, e.prototype.lineDashII = 0, e.prototype.lineDashIII = 0, e.decode = function(r, o, u) {
            r instanceof $Reader || (r = $Reader.create(r));
            for (var d = o === void 0 ? r.len : r.pos + o, s = new $root.com.opensource.svga.ShapeEntity.ShapeStyle(); r.pos < d; ) {
              var f = r.uint32();
              if (f === u)
                break;
              switch (f >>> 3) {
                case 1: {
                  s.fill = $root.com.opensource.svga.ShapeEntity.ShapeStyle.RGBAColor.decode(r, r.uint32());
                  break;
                }
                case 2: {
                  s.stroke = $root.com.opensource.svga.ShapeEntity.ShapeStyle.RGBAColor.decode(r, r.uint32());
                  break;
                }
                case 3: {
                  s.strokeWidth = r.float();
                  break;
                }
                case 4: {
                  s.lineCap = r.int32();
                ...
                case 8: {
                  s.lineDashII = r.float();
                  break;
                }
                case 9: {
                  s.lineDashIII = r.float();
                  break;
                }
                default:
                  r.skipType(f & 7);
            ...
            return r === void 0 && (r = "type.googleapis.com"), r + "/com.opensource.svga.ShapeEntity.ShapeStyle";
          }, e.RGBAColor = function() {
            function i(r) {
              if (r)
                for (var o = Object.keys(r), u = 0; u < o.length; ++u)
                  r[o[u]] != null && (this[o[u]] = r[o[u]]);
            }
            return i.prototype.r = 0, i.prototype.g = 0, i.prototype.b = 0, i.prototype.a = 0, i.decode = function(o, u, d) {
              o instanceof $Reader || (o = $Reader.create(o));
              for (var s = u === void 0 ? o.len : o.pos + u, f = new $root.com.opensource.svga.ShapeEntity.ShapeStyle.RGBAColor(); o.pos < s; ) {
                var c = o.uint32();
                if (c === d)
                  break;
                switch (c >>> 3) {
              ...
              return o === void 0 && (o = "type.googleapis.com"), o + "/com.opensource.svga.ShapeEntity.ShapeStyle.RGBAColor";
            }, i;
          }(), e.LineCap = function() {
            const i = {}, r = Object.create(i);
            return r[i[0] = "LineCap_BUTT"] = 0, r[i[1] = "LineCap_ROUND"] = 1, r[i[2] = "LineCap_SQUARE"] = 2, r;
          }(), e.LineJoin = function() {
            const i = {}, r = Object.create(i);
            return r[i[0] = "LineJoin_MITER"] = 0, r[i[1] = "LineJoin_ROUND"] = 1, r[i[2] = "LineJoin_BEVEL"] = 2, r;
          }(), e;
        }(), n;
      }(), h.FrameEntity = function() {
        function n(a) {
          if (this.shapes = [], a)
            for (var e = Object.keys(a), i = 0; i < e.length; ++i)
              a[e[i]] != null && (this[e[i]] = a[e[i]]);
        }
        return n.prototype.alpha = 0, n.prototype.layout = null, n.prototype.transform = null, n.prototype.clipPath = "", n.prototype.shapes = $util.emptyArray, n.decode = function(e, i, r) {
          e instanceof $Reader || (e = $Reader.create(e));
          for (var o = i === void 0 ? e.len : e.pos + i, u = new $root.com.opensource.svga.FrameEntity(); e.pos < o; ) {
            var d = e.uint32();
            if (d === r)
              break;
            switch (d >>> 3) {
              ...
              case 2: {
                u.layout = $root.com.opensource.svga.Layout.decode(e, e.uint32());
                break;
              }
              case 3: {
                u.transform = $root.com.opensource.svga.Transform.decode(e, e.uint32());
                break;
              }
              case 4: {
                u.clipPath = e.string();
              ...
              case 5: {
                u.shapes && u.shapes.length || (u.shapes = []), u.shapes.push($root.com.opensource.svga.ShapeEntity.decode(e, e.uint32()));
                break;
              }
              default:
                e.skipType(d & 7);
      ...
      }(), h.MovieEntity = function() {
        function n(a) {
          if (this.images = {}, this.sprites = [], this.audios = [], a)
            for (var e = Object.keys(a), i = 0; i < e.length; ++i)
              a[e[i]] != null && (this[e[i]] = a[e[i]]);
        }
        return n.prototype.version = "", n.prototype.params = null, n.prototype.images = $util.emptyObject, n.prototype.sprites = $util.emptyArray, n.prototype.audios = $util.emptyArray, n.decode = function(e, i, r) {
          e instanceof $Reader || (e = $Reader.create(e));
          for (var o = i === void 0 ? e.len : e.pos + i, u = new $root.com.opensource.svga.MovieEntity(), d, s; e.pos < o; ) {
            var f = e.uint32();
            if (f === r)
              break;
            switch (f >>> 3) {
              ...
              case 2: {
                u.params = $root.com.opensource.svga.MovieParams.decode(e, e.uint32());
                break;
              }
              case 3: {
                u.images === $util.emptyObject && (u.images = {});
              ...
              case 4: {
                u.sprites && u.sprites.length || (u.sprites = []), u.sprites.push($root.com.opensource.svga.SpriteEntity.decode(e, e.uint32()));
                break;
              }
              case 5: {
                u.audios && u.audios.length || (u.audios = []), u.audios.push($root.com.opensource.svga.AudioEntity.decode(e, e.uint32()));
                break;
              }
              default:
                e.skipType(f & 7);
...
})(), svga$1 = com.opensource.svga, _ = class _ {
  constructor(t) {
    var h, n, a, e, i, r, o, u, d, s;
    if (this.shapes = [], this.alpha = t.alpha || 0, this.layout = {
      x: ((h = t.layout) == null ? void 0 : h.x) || 0,
      y: ((n = t.layout) == null ? void 0 : n.y) || 0,
      width: ((a = t.layout) == null ? void 0 : a.width) || 0,
      height: ((e = t.layout) == null ? void 0 : e.height) || 0
    }, this.transform = {
      a: ((i = t.transform) == null ? void 0 : i.a) || 1,
      b: ((r = t.transform) == null ? void 0 : r.b) || 0,
      c: ((o = t.transform) == null ? void 0 : o.c) || 0,
      d: ((u = t.transform) == null ? void 0 : u.d) || 1,
      tx: ((d = t.transform) == null ? void 0 : d.tx) || 0,
      ty: ((s = t.transform) == null ? void 0 : s.ty) || 0
    }, this.clipPath = t.clipPath || null, t.shapes)
      if (t.shapes[0] && t.shapes[0].type === svga$1.ShapeEntity.ShapeType.KEEP)
        this.shapes = _.lastShapes;
      else {
        const f = t.shapes.map((c) => {
          if (Object.prototype.hasOwnProperty.call(c, "type") || Object.defineProperty(c, "type", {
            value: c.type,
            enumerable: !0
          }), c.styles) {
            if (c.styles.fill) {
              const { r: p, g, b: y, a: m } = c.styles.fill;
              c.styles.fillStr = `rgba(${parseInt(
                (p * 255).toString()
            ...
            if (c.styles.stroke) {
              const { r: p, g, b: y, a: m } = c.styles.stroke;
              c.styles.strokeStr = `rgba(${parseInt(
                (p * 255).toString()
              )}, ${parseInt((g * 255).toString())}, ${parseInt(
                (y * 255).toString()
              )}, ${m})`;
            }
            switch (c.styles.lineJoin) {
              case svga$1.ShapeEntity.ShapeStyle.LineJoin.LineJoin_MITER:
                c.styles.lineJoinStr = "miter";
                break;
              case svga$1.ShapeEntity.ShapeStyle.LineJoin.LineJoin_ROUND:
                c.styles.lineJoinStr = "round";
                break;
              case svga$1.ShapeEntity.ShapeStyle.LineJoin.LineJoin_BEVEL:
                c.styles.lineJoinStr = "bevel";
                break;
            }
            switch (c.styles.lineCap) {
              case svga$1.ShapeEntity.ShapeStyle.LineCap.LineCap_BUTT:
                c.styles.lineCapStr = "butt";
                break;
              case svga$1.ShapeEntity.ShapeStyle.LineCap.LineCap_ROUND:
                c.styles.lineCapStr = "round";
                break;
              case svga$1.ShapeEntity.ShapeStyle.LineCap.LineCap_SQUARE:
                c.styles.lineCapStr = "square";
                break;
            }
          }
          return c;
        });
        _.lastShapes = f, this.shapes = f;
      }
  }
};
_.lastShapes = [];
...
class VideoEntity {
  constructor(t, h, n) {
    var a, e, i, r;
    this.videoSize = { width: 0, height: 0 }, this.images = {}, this.audios = {}, this.dynamicElements = {}, this.sprites = [], this.version = t.version, this.videoSize.width = ((a = t.params) == null ? void 0 : a.viewBoxWidth) || 0, this.videoSize.height = ((e = t.params) == null ? void 0 : e.viewBoxHeight) || 0, this.FPS = ((i = t.params) == null ? void 0 : i.fps) || 20, this.frames = ((r = t.params) == null ? void 0 : r.frames) || 0, this.sprites = t.sprites.map(({ imageKey: o = null, frames: u }) => ({
      imageKey: o,
      frames: (u || []).map((d) => new FrameEntity(d))
    })), this.images = h, this.audios = n;
  }
}
const v = class v {
  constructor() {
   ...
   */
  static ensureWorker() {
    return this.worker = this.worker || new WorkerWrapper(), this.destroying = !1, this.worker;
  }
  /**
   * Destroy worker
   * @private
  ...
  static destroyWorker() {
    var t;
    (t = this.worker) == null || t.terminate(), this.worker = null, this.destroying = !1;
  }
  /**
   ...
   */
  do(t) {
    const h = new Uint8Array(t, 0, 4);
    if (getVersion(h) === Version.VERSION_1)
      throw new Error("this parser does not support version@1.x of svga.");
    if (!t)
      throw new Error("Parser Data not found");
    return new Promise((n) => {
      const a = v.ensureWorker(), e = v.usageNO++, i = ({
        data: { result: r, id: o }
      }) => {
        o === e && (n(r), a.removeEventListener("message", i), v.workingCount--, v.destroying && this.destroy());
      };
      v.workingCount++, a.addEventListener("message", i), a.postMessage({ data: t, id: e }, [t]);
    });
  }
  /**
...
v.destroying = !1, v.usageNO = 1, v.workingCount = 0;
let Parser = v;
function resetShapeStyles(l, t) {
  t && (l.strokeStyle = (t == null ? void 0 : t.strokeStr) || "transparent", t && (l.lineWidth = t.strokeWidth, l.lineCap = t.lineCapStr, l.lineJoin = t.lineJoinStr, l.miterLimit = t.miterLimit), l.fillStyle = (t == null ? void 0 : t.fillStr) || "transparent", (t.lineDashI || t.lineDashII || t.lineDashIII) && l.setLineDash([
    t.lineDashI ? t.lineDashI : 0,
    t.lineDashII ? t.lineDashII : 0,
    t.lineDashIII ? t.lineDashIII : 0
  ]));
}
function applyTransform(l, t) {
  t && l.transform(
    t.a || 1,
    t.b || 0,
    t.c || 0,
...
function drawEllipse(l, t) {
  var c, p;
  l.save(), resetShapeStyles(l, t.styles), applyTransform(l, t.transform);
  const h = t.x - t.radiusX, n = t.y - t.radiusY, a = t.radiusX * 2, e = t.radiusY * 2, i = 0.5522848, r = a / 2 * i, o = e / 2 * i, u = h + a, d = n + e, s = h + a / 2, f = n + e / 2;
  l.beginPath(), l.moveTo(h, f), l.bezierCurveTo(h, f - o, s - r, n, s, n), l.bezierCurveTo(s + r, n, u, f - o, u, f), l.bezierCurveTo(u, f + o, s + r, d, s, d), l.bezierCurveTo(s - r, d, h, f + o, h, f), (c = t.styles) != null && c.fill && l.fill(), (p = t.styles) != null && p.stroke && l.stroke(), l.restore();
}
function drawRect(l, t) {
  var r, o;
  l.save(), resetShapeStyles(l, t.styles), applyTransform(l, t.transform);
  const h = t.x, n = t.y, a = t.width, e = t.height;
  let i = t.cornerRadius;
  a < 2 * i && (i = a / 2), e < 2 * i && (i = e / 2), l.beginPath(), l.moveTo(h + i, n), l.arcTo(h + a, n, h + a, n + e, i), l.arcTo(h + a, n + e, h, n + e, i), l.arcTo(h, n + e, h, n, i), l.arcTo(h, n, h + a, n, i), l.closePath(), (r = t.styles) != null && r.fill && l.fill(), (o = t.styles) != null && o.stroke && l.stroke(), l.restore();
}
function drawBezier(l, t) {
  var a, e;
  l.save(), resetShapeStyles(l, t.styles), applyTransform(l, t.transform);
  const h = { x: 0, y: 0, x1: 0, y1: 0, x2: 0, y2: 0 };
  l.beginPath(), t.d.replace(/([a-zA-Z])/g, "|||$1 ").replace(/,/g, " ").split("|||").forEach((i) => {
    if (i.length == 0) return;
    const r = i.substr(0, 1), o = i.substr(1).trim().split(" ");
    drawBezierElement(l, h, r, o);
  }), (a = t.styles) != null && a.fill && l.fill(), (e = t.styles) != null && e.stroke && l.stroke(), l.restore();
}
function drawBezierElement(l, t, h, n) {
  switch (h) {
    case "M":
      t.x = Number(n[0]), t.y = Number(n[1]), l.moveTo(t.x, t.y);
      break;
    case "m":
      t.x += Number(n[0]), t.y += Number(n[1]), l.moveTo(t.x, t.y);
      break;
    case "L":
      t.x = Number(n[0]), t.y = Number(n[1]), l.lineTo(t.x, t.y);
      break;
    case "l":
      t.x += Number(n[0]), t.y += Number(n[1]), l.lineTo(t.x, t.y);
      break;
    case "H":
      t.x = Number(n[0]), l.lineTo(t.x, t.y);
      break;
    case "h":
      t.x += Number(n[0]), l.lineTo(t.x, t.y);
      break;
    case "V":
      t.y = Number(n[0]), l.lineTo(t.x, t.y);
      break;
    case "v":
      t.y += Number(n[0]), l.lineTo(t.x, t.y);
      break;
    case "C":
      t.x1 = Number(n[0]), t.y1 = Number(n[1]), t.x2 = Number(n[2]), t.y2 = Number(n[3]), t.x = Number(n[4]), t.y = Number(n[5]), l.bezierCurveTo(
        t.x1,
        t.y1,
        t.x2,
        t.y2,
      ...
      break;
    case "c":
      t.x1 = t.x + Number(n[0]), t.y1 = t.y + Number(n[1]), t.x2 = t.x + Number(n[2]), t.y2 = t.y + Number(n[3]), t.x += Number(n[4]), t.y += Number(n[5]), l.bezierCurveTo(
        t.x1,
        t.y1,
        t.x2,
        t.y2,
      ...
      break;
    case "S":
      t.x1 && t.y1 && t.x2 && t.y2 ? (t.x1 = t.x - t.x2 + t.x, t.y1 = t.y - t.y2 + t.y, t.x2 = Number(n[0]), t.y2 = Number(n[1]), t.x = Number(n[2]), t.y = Number(n[3]), l.bezierCurveTo(
        t.x1,
        t.y1,
        t.x2,
        t.y2,
        t.x,
        t.y
      )) : (t.x1 = Number(n[0]), t.y1 = Number(n[1]), t.x = Number(n[2]), t.y = Number(n[3]), l.quadraticCurveTo(
        t.x1,
        t.y1,
        t.x,
        t.y
      ...
      break;
    case "s":
      t.x1 && t.y1 && t.x2 && t.y2 ? (t.x1 = t.x - t.x2 + t.x, t.y1 = t.y - t.y2 + t.y, t.x2 = t.x + Number(n[0]), t.y2 = t.y + Number(n[1]), t.x += Number(n[2]), t.y += Number(n[3]), l.bezierCurveTo(
        t.x1,
        t.y1,
        t.x2,
        t.y2,
        t.x,
        t.y
      )) : (t.x1 = t.x + Number(n[0]), t.y1 = t.y + Number(n[1]), t.x += Number(n[2]), t.y += Number(n[3]), l.quadraticCurveTo(
        t.x1,
        t.y1,
        t.x,
        t.y
...
const svga = com.opensource.svga;
function render(l, t, h, n, a) {
  const e = l.getContext("2d");
  return e === null ? (console.error("svga render fail, 2d context null"), l) : (n.forEach((i) => {
    var d;
    const r = i.frames[a];
    if (r.alpha < 0.05)
      return;
    e.save(), e.globalAlpha = r.alpha, e.transform(
      r.transform.a || 1,
      r.transform.b || 0,
      r.transform.c || 0,
      r.transform.d || 1,
    ...
    const o = i.imageKey && t[i.imageKey];
    o && (r.clipPath && (drawBezier(e, {
      d: r.clipPath
    }), e.clip()), o instanceof Image ? e.drawImage(o, 0, 0, o.width, o.height) : e.drawImage(o, 0, 0));
    const u = i.imageKey && h[i.imageKey];
    if (u) {
      const { source: s, fit: f } = "fit" in u ? u : { source: u, fit: "none" };
      let c, p;
      switch (s instanceof HTMLImageElement ? (c = s.naturalWidth, p = s.naturalHeight) : s instanceof HTMLVideoElement ? (c = s.videoWidth, p = s.videoHeight) : s instanceof SVGImageElement ? (c = s.width.baseVal.value, p = s.height.baseVal.value) : s instanceof VideoFrame ? (c = s.codedWidth, p = s.codedHeight) : (c = s.width, p = s.height), f) {
        case "contain": {
          const g = r.layout.width / c, y = r.layout.height / p, m = Math.min(g, y), b = m * c, w = m * p;
          e.drawImage(
            s,
            (r.layout.width - b) / 2,
            (r.layout.height - w) / 2,
        ...
        case "cover": {
          const g = r.layout.width / c, y = r.layout.height / p, m = Math.max(g, y), b = m * c, w = m * p;
          e.drawImage(
            s,
            (r.layout.width - b) / 2,
            (r.layout.height - w) / 2,
    ...
    (d = r.shapes) == null || d.forEach((s) => {
      s.type === svga.ShapeEntity.ShapeType.SHAPE && s.shape && s.shape.d ? drawBezier(e, {
        d: s.shape.d,
        transform: s.transform,
        styles: s.styles
      }) : s.type === svga.ShapeEntity.ShapeType.ELLIPSE && s.ellipse ? drawEllipse(e, {
        x: s.ellipse.x || 0,
        y: s.ellipse.y || 0,
        radiusX: s.ellipse.radiusX || 0,
        radiusY: s.ellipse.radiusY || 0,
        transform: s.transform,
        styles: s.styles
      }) : s.type === svga.ShapeEntity.ShapeType.RECT && s.rect && drawRect(e, {
        x: s.rect.x || 0,
        y: s.rect.y || 0,
        width: s.rect.width || 0,
        height: s.rect.height || 0,
        cornerRadius: s.rect.cornerRadius || 0,
        transform: s.transform,
        styles: s.styles
      });
    }), e.restore();
...
function polyfillCreateImageBitmap() {
  "createImageBitmap" in window || Object.assign(window, {
    createImageBitmap: async function(l) {
...
class Renderer {
  constructor(t) {
    this.audios = [], this.audioConfigs = {}, this.isCacheFrame = !1, this.frameCache = {}, polyfillCreateImageBitmap(), this.target = t, this.offscreenCanvas = window.OffscreenCanvas ? new window.OffscreenCanvas(t.width, t.height) : document.createElement("canvas");
  }
  async prepare(t) {
    this.audios = [], this.audioConfigs = {}, this.target.width !== t.videoSize.width && (this.target.width = t.videoSize.width), this.target.height !== t.videoSize.height && (this.target.height = t.videoSize.height);
    const h = (e, i) => {
      const r = this.audioConfigs[e] || [];
      r.push(i), this.audioConfigs[e] = r;
    }, n = Object.entries(t.images).map(
      async ([e, i]) => {
        if (i instanceof ArrayBuffer) {
          const r = new Blob([i], { type: "image/png" }), o = await createImageBitmap(r);
          t.images[e] = o;
        }
        return i;
      }
    ), a = Object.values(t.audios).map(
      ({ source: e, startFrame: i, endFrame: r, audioKey: o, startTime: u, totalTime: d }) => new Promise((s) => {
        const f = new Audio(
          URL.createObjectURL(
            new Blob([new Uint8Array(e)], { type: "audio/x-mpeg" })
          )
        ), c = {
          audioKey: o,
          audio: f,
        ...
        h(i, c), h(r, c), this.audios.push(f), f.onloadeddata = s, f.load();
      })
    );
    await Promise.all([...a, ...n]);
  }
  processAudio(t) {
    const h = this.audioConfigs[t];
    !h || h.length === 0 || h.forEach(function(n) {
      if (n.startFrame === t) {
        n.audio.currentTime = n.startTime, n.audio.play();
        return;
      }
      if (n.endFrame === t) {
        n.audio.pause(), n.audio.currentTime = 0;
        return;
      }
    });
  }
  clear() {
    const t = this.target.getContext("2d");
    t == null || t.clearRect(0, 0, this.target.width, this.target.height);
  }
  drawFrame(t, h, n, a) {
    const e = this.target.getContext("2d");
    if (!e)
      return;
    if (e.clearRect(0, 0, this.target.width, this.target.height), this.isCacheFrame && this.frameCache[a]) {
      const r = this.frameCache[a];
      e.drawImage(r, 0, 0);
      return;
    }
    const i = this.offscreenCanvas;
    i.width = this.target.width, i.height = this.target.height, render(i, t, n, h, a), e.drawImage(i, 0, 0), this.isCacheFrame && createImageBitmap(i).then((r) => {
      this.frameCache[a] = r;
    });
  }
  stopAllAudio() {
    this.audios.forEach(function(t) {
...
var FILL_MODE = /* @__PURE__ */ ((l) => (l.FORWARDS = "forwards", l.BACKWARDS = "backwards", l))(FILL_MODE || {});
class Animator {
  constructor() {
    this.noExecutionDelay = !1, this.startValue = 0, this.endValue = 0, this.duration = 0, this.repeatNumber = 1, this.loop = !1, this.fillRule = "forwards", this.onUpdate = noop, this.onEnd = noop, this.isRunning = !1, this.startTimestamp = 0, this.timeoutWorker = null, this.doFrame = () => {
      const t = Animator.currentTimeMillisecond() - this.startTimestamp;
      let h;
      !this.loop && t >= this.duration * this.repeatNumber ? (h = this.fillRule === "backwards" ? 0 : 1, this.isRunning = !1) : h = t % this.duration / this.duration;
      const n = (this.endValue - this.startValue) * h + this.startValue;
      this.onUpdate(n), this.isRunning ? this.timeoutWorker ? (this.timeoutWorker.onmessage = this.doFrame, this.timeoutWorker.postMessage(null)) : window.requestAnimationFrame(this.doFrame) : (this.timeoutWorker !== null && (this.timeoutWorker.terminate(), this.timeoutWorker = null), this.onEnd());
    };
  }
  /**
   ...
   */
  start(t) {
    this.isRunning = !0, this.startTimestamp = Animator.currentTimeMillisecond(), t && (this.startTimestamp -= t / (this.endValue - this.startValue) * this.duration), this.noExecutionDelay && this.timeoutWorker === null && (this.timeoutWorker = new Worker(
...
var EVENT_TYPES = /* @__PURE__ */ ((l) => (l.START = "start", l.PROCESS = "process", l.PAUSE = "pause", l.RESUME = "resume", l.STOP = "stop", l.END = "end", l.CLEAR = "clear", l))(EVENT_TYPES || {}), PLAY_MODE = /* @__PURE__ */ ((l) => (l.FORWARDS = "forwards", l.FALLBACKS = "fallbacks", l))(PLAY_MODE || {});
class Player {
  constructor(t, h, n) {
    if (this.currentFrame = 0, this.videoItem = null, this.playMode = "forwards", this.startFrame = 0, this.endFrame = 0, this.intersectionObserverRenderShow = !0, this.intersectionObserver = null, this.$onEvent = {
      ...
      clear: noop
    }, this.container = typeof t == "string" ? document.body.querySelector(t) : t, !this.container)
      throw new Error("container undefined.");
    if (!this.container.getContext)
      throw new Error("container should be HTMLCanvasElement.");
    this.renderer = new Renderer(this.container), this.animator = new Animator(), h && this.mount(h), n && this.set(n);
  }
  get progress() {
  ...
  set({
    loop: t = !0,
    fillMode: h = FILL_MODE.FORWARDS,
    playMode: n = "forwards",
    startFrame: a = 0,
    endFrame: e = 0,
    cacheFrames: i = !1,
    intersectionObserverRender: r = !1,
    noExecutionDelay: o = !1
  }) {
    this.playMode = n, this.startFrame = a, this.endFrame = e, this.handleIntersectionObserver(r), this.setAnimatorLoop(t), this.animator.fillRule = h, this.animator.noExecutionDelay = o, this.renderer.isCacheFrame = i;
  }
  mount(t) {
    return this.currentFrame = 0, this.videoItem = t, this.renderer.prepare(t);
  }
  start() {
    if (!this.videoItem)
  ...
  resume() {
    this.animator.start(this.currentFrame), this.$onEvent.resume();
  }
  pause() {
    this.animator.stop(), this.$onEvent.pause();
  }
  stop() {
    this.animator.stop(), this.renderer.clear(), this.currentFrame = 0, this.renderer.stopAllAudio(), this.$onEvent.stop();
  }
  clear() {
    this.animator.stop(), this.renderer.clear(), this.$onEvent.clear();
  }
  destroy() {
    this.animator.stop(), this.renderer.clear(), this.videoItem = null;
  }
  $on(t, h) {
    return this.$onEvent[t] = h, t === "end" && (this.animator.onEnd = () => this.$onEvent.end()), this;
  }
  /**
   * 监听容器是否处于浏览器视窗内
   * @param on
   * @private
   */
  handleIntersectionObserver(t) {
    typeof window < "u" && "IntersectionObserver" in window && t ? (this.intersectionObserver = new IntersectionObserver(
      (n) => {
        var a;
        this.intersectionObserverRenderShow = ((a = n[0]) == null ? void 0 : a.intersectionRatio) > 0;
      },
      {
        rootMargin: "0px",
        threshold: [0, 0.5, 1]
  ...
  setAnimatorLoop(t) {
    switch (typeof t) {
      case "boolean":
        this.animator.loop = t;
        break;
      case "number":
        t <= 0 ? (console.warn(
          '[svga-web] set loop to 0 is deprecated, use "loop: true" instead'
        ), this.animator.loop = !0) : (this.animator.loop = !1, this.animator.repeatNumber = t);
    }
  }
  /**
   * Start animation
  ...
  startAnimation({
    ...
    const { playMode: i, startFrame: r, endFrame: o } = this, u = n - 1;
    this.currentFrame === u && (this.currentFrame = r || 0), this.animator.startValue = i === "fallbacks" ? o || u : r || 0, this.animator.endValue = i === "fallbacks" ? r || 0 : o || u, o > 0 && o > r ? n = o - r : o <= 0 && r > 0 && (n = n - r), this.animator.duration = n * (1 / a) * 1e3, this.animator.onUpdate = (d) => {
      d = Math.floor(d), this.currentFrame !== d && (this.playMode === "forwards" && this.renderer.processAudio(d), this.currentFrame = d, this.intersectionObserverRenderShow && this.renderer.drawFrame(
        t,
        h,
        e,
        this.currentFrame
...
const version = "2.4.0";
class DB {
  constructor({ name: t, storeName: h } = {
    name: "svga-web." + version,
    storeName: "svga_file"
  }) {
    this.storeName = h, this.dbPromise = new Promise(function(n, a) {
      if (window.indexedDB) {
        const e = window.indexedDB.open(t);
        e.onerror = function(i) {
          a(new Error("[svgaWeb.DB] indexedDB open fail" + i));
        }, e.onsuccess = function() {
          n(e.result);
        }, e.onupgradeneeded = function() {
          const i = e.result;
          i.objectStoreNames.contains(h) || i.createObjectStore(h);
        };
      } else
  ...
  async find(t) {
    return this.dbPromise.then(
      (h) => new Promise((n) => {
        const e = h.transaction([this.storeName], "readonly").objectStore(this.storeName).get(t);
  ...
  async insert(t, h) {
    return this.dbPromise.then(
      (n) => new Promise((a) => {
        const e = n.transaction([this.storeName], "readwrite");
        e.objectStore(this.storeName).put(h, t), e.oncomplete = a;
      })
    );
  }
  async delete(t) {
    return this.dbPromise.then(
      (h) => new Promise((n) => {
        const e = h.transaction([this.storeName], "readwrite").objectStore(this.storeName).delete(t);
        e.onsuccess = n;
      })
    );
  }
